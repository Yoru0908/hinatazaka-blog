...
本仓库由 `sakamichi-blog-backend` 自动抓取并翻译日向坂46 官方博客后，将双语 Markdown 内容写入此仓库。

## 目录结构

```
content/posts/<YYYY>/<MM>/hinatazaka46/<YYYY-MM-DD>-<标题>-hinatazaka-<ID>.md
```
...
- 官方博客：https://www.hinatazaka46.com/s/official/diary/MEMBER/list
